...
import { VerificationChart } from '@/components/admin/verification-chart'
    ...
    <div className="flex h-screen bg-gray-50/50">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header className="flex items-center justify-between px-8 py-4 bg-white border-b border-gray-200">
          <h2 className="text-2xl font-bold text-[#1a365d]">Admin Dashboard</h2>
          ...
          <div className="max-w-6xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 space-y-3">
                <h3 className="font-semibold text-gray-900">Pending Verification Requests</h3>
                <Card className="rounded-xl shadow-sm border-gray-200 h-full">
                  <CardContent className="p-0">
                        ...
                        <div key={req.id} className="p-5 flex items-center justify-between hover:bg-gray-50 transition-colors">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-500">{req.program}</p>
                              <p className="text-[10px] text-gray-400 mt-0.5">{req.email}</p>
                            </div>
                          </div>
                          <div className="flex items-center gap-2">
                            <Button variant="outline" size="sm" className="h-8 text-emerald-600 border-emerald-200 hover:bg-emerald-50 hover:text-emerald-700">
                    ...
                    <div className="p-4 border-t border-gray-100 bg-gray-50/50 rounded-b-xl text-center">
                      <a href="/dashboard/admin/verifications" className="text-sm font-semibold text-blue-600 hover:text-blue-800 transition-colors">
              ...
              <div className="space-y-3">
                ...
                <Card className="rounded-xl shadow-sm border-gray-200">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm text-gray-500 font-normal">All Time Overview</CardTitle>
                  </CardHeader>
                  <CardContent>
